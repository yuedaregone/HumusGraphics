...
ShaderID Direct3D10Renderer::addShader(const char *vsText, const char *gsText, const char *fsText, const char * /*csText*/, const int vsLine, const int gsLine, const int fsLine, const int /*csLine*/,
...
void Direct3D10Renderer::changeToMainFramebuffer(){
	...
	D3D10_VIEWPORT vp = { 0, 0, (UINT) viewportWidth, (UINT) viewportHeight, 0.0f, 1.0f };
	device->RSSetViewports(1, &vp);
