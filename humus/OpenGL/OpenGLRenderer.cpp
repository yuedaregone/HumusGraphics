...
ShaderID OpenGLRenderer::addShader(const char *vsText, const char *gsText, const char *fsText, const char * /*csText*/, const int vsLine, const int gsLine, const int fsLine, const int /*csLine*/,
